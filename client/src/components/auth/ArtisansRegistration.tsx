...
function ArtisansRegistration() {
  ...
  return (
    <>
      <NavLanding />
      <div className=" bg-gray-50 flex flex-col justify-center  px-2 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto w-full">
          <h2 className="text-center text-3xl font-extrabold text-gray-900 my-3">Create your account</h2>
...
<div>
  ...
  {errors.district && <p className="text-red-500 text-sm">{errors.district}</p>}
            ...
            <div className="md:col-span-2 text-center text-sm">
              ...
              <a href="/artisan/login" className="text-indigo-600 hover:underline">
                Login Now
              </a>
            </div>
          </form>
